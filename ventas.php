...
$password = $_SESSION['clave'];
 ...
 ?>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="mdb/MDB-Free_4.15.0/css/addons/datatables.min.css">
      ...
      <div class="container col-xl-9 col-lg-10 col-md-10 col-10 " id="caja">
        <div class="">
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle text-dark font-weight-normal" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                <?php echo $nombre ?>
              </a>
          ...
          <div id="myTabContent" class="tab-content" id="contenido" style="position:static;!important">
            <div class="tab-pane fade active show text-dark text-center" id="home">
              ...
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">Usted esta logueado con el correo:
                    <?php echo $correo?>
                  </p>
                  ...
                  <div class="row">
                    <div class="col-xl-8" style="">
                      ...
                      <div class="container-fluid mt-3">
                        <div class="row">
                          ...
                          <div class="col-xl-3" style="padding-top:15px;">
                            <button id="btn-reg-cliente" type="button" class="btn mt-1 btn-pink" data-toggle="modal" data-target="#modalRegisterForm">
                          ...
                          <div class="container-fluid">
                            <div class="row">
                              ...
                              <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-xs-3 col-3 ">
                                ...
                                <input id= "precio_actual" class="form-control font-weight borrar " type="text" placeholder="Lps 0 " readonly>
                                </div>
                              </div>
                    ...
                    <div class="col-xl-4 mt-5 d-none d-xl-block" style="margin-top: 10px;">
                      ...
                      <div class="col-xl-6 mt-5" style="margin:auto; margin-top:10px;">
                        <button type="submit" class="btn btn-light btn-lg waves-effect" name="" form="formulario">Imprimir Factura</button>
                      </div>
                    </div>
                  </div>
            ...
            <div class="tab-pane fade" id="compras">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalConfirmDelete">Launch modal
              </button>
            ...
            <div class="tab-pane fade" id="dropdown2">
              <p>Trust fund seitan letterpress, keytar raw denim keffiyeh etsy art party before they sold out master cleanse gluten-free squid scenester freegan cosby sweater. Fanny pack portland seitan DIY, art party locavore wolf cliche high life echo
                park Austin. Cred vinyl keffiyeh DIY salvia PBR, banh mi before they sold out farm-to-table VHS viral locavore cosby sweater.</p>
            </div>
          </div>
        </div>
        <div class="corte">
...
-->
      ...
      <div class="modal fade" id="modalPush" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-notify modal-info" role="document">
          <div class="modal-content text-center">
            ...
            <div class="modal-footer flex-center">
              <button href="" type="submit" class="btn btn-info" onClick="location.reload();">Si</button>
              ...
              <div class="modal-body ">
                <form id="form-registro">
                  <div class="row">
                    ...
                    <div class="md-form mb-5 col-xl-4 animated bounce infinite slower" id="reg-alert">
      ...
      <script type="text/javascript" src="mdb/MDB-Free_4.15.0/js/addons/datatables.min.js"></script>
      <script type="text/javascript" src="js/factura.js"></script>
      <script type="text/javascript" src="js/id-factura.js"></script>
      <script type="text/javascript" src="js/registro-clientes.js"></script>
